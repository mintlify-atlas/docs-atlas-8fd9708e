...
<CardGroup cols={2}>
  ...
  <Card title="Inference Guide" icon="book" href="/inference/overview">
    Complete guide to transcription workflows
  </Card>
  
  <Card title="Supported Languages" icon="earth-americas" href="/getting-started/supported-languages">
